...
import java_assignments.assignment8.cab.booking.CabType;
import java_assignments.assignment8.cab.booking.SmartCabBooking;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            cabType = CabType.valueOf(cabInput.trim().toUpperCase());
        } catch (IllegalArgumentException e) {
            System.out.println("Invalid cab type. Please enter MINI, SEDAN, or SUV.");
            scanner.close();
            return;
        }
